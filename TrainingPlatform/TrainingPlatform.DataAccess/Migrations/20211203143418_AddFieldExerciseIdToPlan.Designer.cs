...
namespace TrainingPlatform.DataAccess.Migrations
{
    ...
    [Migration("20211203143418_AddFieldExerciseIdToPlan")]
    partial class AddFieldExerciseIdToPlan
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrainingPlatform.DataAccess.Entities.ContentFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TrainingPlatform.DataAccess.Entities.File", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TrainingPlatform.DataAccess.Entities.ContentFile", b =>
                {
                    b.HasOne("TrainingPlatform.DataAccess.Entities.File", "File")
                        .WithOne("ContentFile")
                        .HasForeignKey("TrainingPlatform.DataAccess.Entities.ContentFile", "FileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TrainingPlatform.DataAccess.Entities.Exercise", b =>
                {
                    b.HasOne("TrainingPlatform.DataAccess.Entities.File", "File")
                        .WithOne("Exercise")
                        .HasForeignKey("TrainingPlatform.DataAccess.Entities.Exercise", "FileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
